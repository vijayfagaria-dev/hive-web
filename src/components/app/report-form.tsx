...
const field =
  "h-11 w-full rounded-lg border border-white/15 bg-white/[0.03] px-3 text-sm outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40";
...
export function ReportForm({
  ...
  function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    report.mutate(
      { accusedId: Number(data.get("accusedId")), ruleId: Number(data.get("ruleId")) },
      {
        onSuccess: () => {
